...
require (
	...
	github.com/rollkit/rollkit v0.10.1-0.20230720173405-9177a48bcfa5
...
require (
	cosmossdk.io/x/feegrant v0.0.0-20230720173129-e3482f2d4142 // indirect
...
replace (
	...
	// Use cometbft with Fraud Proofs
